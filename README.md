...
- <img src="https://promptguardscan.space/favicon.svg" height="14"/> [PromptGuard Scan MCP](https://github.com/clauxel/prompt-injection-scanner-mcp) - Paid remote MCP for LLM security testing: prompt injection scans, jailbreak checks, hidden-instruction leakage review, unsafe tool-use signals, and CI/CD release-gate context.
